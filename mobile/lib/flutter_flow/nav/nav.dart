...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'UserInformationSheet',
          path: '/userInformationSheet',
          builder: (context, params) => const UserInformationSheetWidget(),
        ),
        FFRoute(
          name: 'ChatBot',
          path: '/chatBot',
        ...
        FFRoute(
          name: 'SampleBill',
          path: '/sampleBill',
          builder: (context, params) => const SampleBillWidget(),
        )
